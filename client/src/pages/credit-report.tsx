...
import { ChevronDown, ChevronUp, CheckIcon, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-2 px-4">
        ...
        <div className="mb-4" ref={creditAccountsRef} data-section="credit-accounts">
          {creditAccountsCollapsed ? (
            <CollapsedCreditCard
              ...
              warningCount={hasUnsavedNegatives ? negativeAccounts.length : 0}
              isOpen={!creditAccountsCollapsed}
              onToggle={toggleCreditAccounts}
            />
          ) : (
              ...
              >
                <div className="min-h-0 flex flex-col">
                  ...
                  <NegativeAccountsSection
                    ref={negativeAccountsRef}
                    data-section="negative-accounts"
        ...
        <div data-section="public-records">
